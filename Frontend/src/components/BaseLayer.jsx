    ...
    return (
        ...
        style={{
            ...
            <div
                ...
                style={{
                    background: (plotWaterPatch && layerIdx === 0 && (isFiltered)) ? `${grassStyles[2]}, rgba(33, 148, 183, ${1 - timeFilter})`:
                    (plotWaterPatch && layerIdx === 0) ? `${grassStyles[2]}, rgba(33, 148, 183, ${1 - timeFilter})`:
            ...
            {(!plotWaterPatch && layerIdx === 0) && (
                ...
                bgSize={'114% 405px'} timeFilter={timeFilter}
                ...
                bgSize={'620px 114%'} timeFilter={timeFilter} 
